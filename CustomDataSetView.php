...
/**
 * Class CustomDataSetView
 * @package Xibo\Widget
 */
class CustomDataSetView extends ModuleWidget
{
    /** @inheritdoc */
    ...
    public function installOrUpdate($moduleFactory)
    {
        if ($this->module == null) {
            ...
            $module->name = 'CustomDataSetView';
            $module->type = 'CustomDataSetView';
            $module->class = 'Xibo\Custom\CustomDataSetView';
            $module->description = 'A custom dataset module.';
            $module->enabled = 1;
            ...
            $module->settings = [];
            $module->viewPath = '../custom/customdatasetview';
            $module->installName = 'customdatasetview';
    ...
    {
        return 'customdatasetview-designer-javascript';
    }
    ...
    public function editForm(Request $request)
    {
        ...
        if ($step == 1 || !$this->hasDataSet() && $this->getOption('useQuery') != '1') {
            return 'customdatasetview-form-edit-step1';
        } else {
            return 'customdatasetview-form-edit';
        }
    }
