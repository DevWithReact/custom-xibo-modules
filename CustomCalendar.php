 ...
 * @package Xibo\Custom
 */
class CustomCalendar extends ModuleWidget
{
    ...
    public function installOrUpdate($moduleFactory)
    {
        if ($this->module == null) {
            ...
            $module->name = 'CustomCalendar';
            $module->type = 'customcalendar';
            $module->class = 'Xibo\Custom\CustomCalendar';
            $module->description = 'A custom calendar module.';
            $module->enabled = 1;
            ...
            $module->settings = [];
            $module->viewPath = '../custom/customcalendar';
            $module->installName = 'customcalendar';
    ...
    {
        return 'customcalendar-designer-javascript';
    }
